...
/**
 * Tech stack — grouped by category. NO percentages; we use confidence tags
 * (Daily / Solid / Familiar) to convey experience without false precision.
 */
...
export const SKILL_GROUPS: SkillGroup[] = [
  {
    ...
    skills: [
      { name: "LangChain", level: "daily" },
      { name: "LangGraph", level: "daily" },
      { name: "Gemini API", level: "daily" },
      { name: "Groq", level: "daily" },
      { name: "OpenAI API", level: "daily" },
      { name: "Hugging Face", level: "solid" },
      { name: "PyTorch", level: "solid" },
      { name: "scikit-learn", level: "solid" },
      { name: "TensorFlow / Keras", level: "familiar" },
      { name: "RAG", level: "daily" },
      { name: "Prompt Engineering", level: "daily" },
      { name: "Multi-Agent Systems", level: "daily" },
      { name: "Computer Vision", level: "solid" },
      { name: "Physics-Informed NN", level: "solid" },
      { name: "Anomaly Detection", level: "solid" },
      { name: "MLOps / W&B", level: "familiar" },
    ],
  },
  {
    id: "backend",
    ...
    skills: [
      ...
      { name: "Django + DRF", level: "solid" },
      { name: "Flask", level: "solid" },
      { name: "SQLAlchemy", level: "daily" },
      { name: "Pydantic", level: "daily" },
      { name: "REST APIs", level: "daily" },
      { name: "GraphQL", level: "familiar" },
      { name: "WebSockets", level: "solid" },
      { name: "OAuth 2.0 / JWT", level: "solid" },
      { name: "Microservices", level: "solid" },
      { name: "OpenAPI / Swagger", level: "daily" },
  ...
  },
  {
    ...
    skills: [
      { name: "QKD Protocols (BB84)", level: "solid" },
      { name: "E91 Protocol", level: "solid" },
      { name: "CV-QKD", level: "solid" },
      { name: "Qiskit", level: "familiar" },
      { name: "Cirq", level: "familiar" },
      { name: "PennyLane", level: "familiar" },
      { name: "Quantum Cryptography", level: "solid" },
      { name: "PyPI Packaging", level: "daily" },
    ],
  },
  {
    id: "avionics",
    ...
    skills: [
      { name: "Embedded C/C++", level: "daily" },
      { name: "Teensy 4.1", level: "solid" },
      { name: "Arduino", level: "solid" },
      { name: "Sensor Fusion", level: "solid" },
      { name: "Kalman Filtering", level: "solid" },
      { name: "Telemetry / GCS", level: "solid" },
      { name: "XBee S2C", level: "solid" },
      { name: "I2C / SPI / UART", level: "daily" },
      { name: "ADCS", level: "familiar" },
      { name: "Fault Tolerance", level: "solid" },
      { name: "Finite State Machines", level: "daily" },
      { name: "Real-time Systems", level: "solid" },
    ],
  },
  {
    id: "frontend",
    ...
    skills: [
      ...
      { name: "GSAP", level: "solid" },
      { name: "Three.js / R3F", level: "solid" },
      { name: "HTML5 / CSS3", level: "daily" },
      { name: "Bootstrap", level: "familiar" },
      { name: "Streamlit", level: "solid" },
      { name: "Responsive Design", level: "daily" },
      { name: "SSR / SSG", level: "solid" },
    ],
  },
  {
    id: "databases",
    ...
    skills: [
      ...
      { name: "Neon DB", level: "daily" },
      { name: "Supabase", level: "daily" },
      { name: "SQLModel", level: "solid" },
      { name: "Query Optimization", level: "solid" },
      { name: "Indexing", level: "solid" },
      { name: "ACID Transactions", level: "solid" },
    ],
  },
  {
    id: "devops",
    ...
    skills: [
      ...
      { name: "Docker Compose", level: "daily" },
      { name: "Git", level: "daily" },
      { name: "GitHub Actions", level: "daily" },
      { name: "CI/CD Pipelines", level: "daily" },
      { name: "GCP", level: "solid" },
      { name: "AWS", level: "solid" },
      { name: "Vercel", level: "daily" },
      { name: "Linux", level: "daily" },
      { name: "Serverless", level: "solid" },
      { name: "Sentry / Observability", level: "daily" },
      { name: "n8n", level: "familiar" },
    ],
  },
  {
    id: "fintech",
    ...
    skills: [
      { name: "NSE/BSE APIs", level: "solid" },
      { name: "Upstox API", level: "solid" },
      { name: "pandas-ta", level: "solid" },
      { name: "Market Sentiment Analysis", level: "solid" },
      { name: "Multi-Asset Trading", level: "familiar" },
      { name: "Backtesting", level: "solid" },
      { name: "Risk Management", level: "solid" },
      { name: "Paper Trading", level: "solid" },
    ],
  },
  {
    id: "practices",
    ...
    skills: [
      ...
      { name: "Test-Driven Dev", level: "daily" },
      { name: "Code Review", level: "daily" },
      { name: "System Design", level: "solid" },
      { name: "Debugging", level: "daily" },
      { name: "Performance Optimization", level: "solid" },
      { name: "Technical Documentation", level: "daily" },
      { name: "Production Support", level: "solid" },
    ],
  },
];
...
export const CERTIFICATIONS = [
  // Space & Aerospace
  { name: "ISRO START 2023", org: "ISRO", category: "Space" },
  { name: "SMOPS 2023 — Participation", org: "ISRO", category: "Space" },
  {
